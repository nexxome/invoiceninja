...
class AccountTransformer extends EntityTransformer
{
    ...
    public function transform(Account $account)
    {
        return [
            ...
            'custom_design4' => $account->custom_design4,
            'custom_design5' => $account->custom_design5,
            'custom_design6' => $account->custom_design6,
            'custom_design7' => $account->custom_design7,
            'custom_design8' => $account->custom_design8,
            'custom_design9' => $account->custom_design9,
            'custom_design10' => $account->custom_design10,
