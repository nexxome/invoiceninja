...
class InvoiceDesign extends Eloquent
{
    ...
    public static function getDesigns()
    {
        ...
        foreach ($designs as $design) {
            ...
            if (in_array($design->id, [CUSTOM_DESIGN1, CUSTOM_DESIGN2, CUSTOM_DESIGN3, CUSTOM_DESIGN4, CUSTOM_DESIGN5, CUSTOM_DESIGN6, CUSTOM_DESIGN7, CUSTOM_DESIGN8, CUSTOM_DESIGN9, CUSTOM_DESIGN10])) {
